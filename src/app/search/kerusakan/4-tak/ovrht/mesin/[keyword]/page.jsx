...
const Page = async ({ params }) => {
    ...
    const searchDamage = await getDamageResponse("search/kerusakan/4-tak/mesin", `q=${keyword}`)
        ...
        <>
            <section>
                <div className="grid-cols-1 container mx-auto items-center pt-6 pb-4 overflow-hidden rounded-lg shadow transition hover:shadow-lg">
                    <h1 className="font-semibold text-4xl p-4">Pencarian Kerusakan Pada Komponen Utama Mesin</h1>
                    <h3 className="font-semibold text-2xl px-4 mb-8">Mesin Overheat, atau Peningkatan Suhu Mesin</h3>
                    <InputSearch/>
