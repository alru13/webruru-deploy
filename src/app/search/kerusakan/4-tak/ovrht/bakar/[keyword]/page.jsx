...
const Page = async ({ params }) => {
    ...
    const searchDamage = await getDamageResponse("search/kerusakan/4-tak/bakar", `q=${keyword}`)
        ...
        <>
            <section>
                <div className="grid-cols-1 container mx-auto items-center pt-6 pb-4 overflow-hidden rounded-lg shadow transition hover:shadow-lg">
                    <h1 className="font-semibold text-4xl p-4">Pencarian Kerusakan Pada Sistem Bahan Bakar</h1>
